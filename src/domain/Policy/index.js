        ...
        <div id="wrap">
            <main class="policy-area lightgrey">
                <div class="grid">
                    ...
                    <p class="policy-txt pt60 fs18">ASAP(이하 ＂사무국＂라 함)은 이용자의 개인정보를 중요시하며, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」, 「개인정보보호법」을 준수하기 위하여 노력하고 있습니다.<br />사무국은 개인정보처리방침을 통하여 사무국이 이용자로부터 제공받은 개인정보를 어떠한 용도와 방식으로 이용하고 있으며, 개인정보보호를 위해 어떠한 조치를 취하고 있는지 알려드립니다.<br /><br />이 개인정보처리방침은 2021년 1월 15일부터 시행됩니다.<br />사무국은 본 개인정보처리방침을 변경(내용의 추가, 삭제 또는 정정)할 경우 해당, 적용일자 및 변경 사유를 웹사이트에 명시하여 그 적용일자 7일 이전부터 적용일자 전일까지 공지하는 방법으로 회원에게 통지합니다.</p>
                    ...
                    <dl class="policy-wrap">
                        ...
                        <dd>
                            <p class="fs18 policy-txt">사무국은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br /><br />① 개인정보 보호 책임자 : OOO 대표<br />② 개인정보 보호 담당자 : OOO<br />③ 전화번호 : 01-2345-6789<br />④ 문의처 : abc@asap.com</p>
                        </dd>
                    </dl>
                    <dl class="policy-wrap">
